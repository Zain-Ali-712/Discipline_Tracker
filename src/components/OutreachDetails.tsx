      ...
      <div className={`rounded-3xl border-2 shadow-xl transition-colors duration-300 ${theme === 'dark'
        ...
        <div className="p-6">
          <div className={`text-center py-8 rounded-xl ${theme === 'dark' ? 'bg-gray-900/50' : 'bg-gray-100'
            ...
            <div className={`text-lg mt-2 ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'
              }`}>
    ...
    <div className={`rounded-3xl border-2 shadow-xl transition-colors duration-300 ${theme === 'dark'
      ...
      <div className={`p-6 border-b ${theme === 'dark'
        ...
        <div className="mt-6">
          ...
          <div className={`flex justify-between text-lg font-medium mt-2 ${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'
            }`}>
            <span>0</span>
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          {Object.entries(pitches).map(([platform, count]) => (
            ...
            >
              ...
              {/* All-time total */}
              <div className={`mb-3 p-2 rounded-lg ${theme === 'dark' ? 'bg-gray-800/70' : 'bg-gray-100'
                }`}>
                <div className="flex justify-between items-center">
                  <div className={`text-sm ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'
                    }`}>
              ...
              <div className="mt-3">
                ...
                <div className={`flex justify-between text-sm mt-1.5 ${theme === 'dark' ? 'text-gray-500' : 'text-gray-600'
                  }`}>
                  <span>0</span>
        ...
        <div className={`p-5 rounded-xl border-2 ${theme === 'dark'
          ...
          <div className={`mt-4 pt-4 border-t ${theme === 'dark' ? 'border-gray-700' : 'border-gray-300'
            ...
            <div className={`text-center text-lg font-medium mt-3 ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'
              }`}>
              All-time Total Pitches: <span className={`font-bold text-2xl ${theme === 'dark' ? 'text-white' : 'text-gray-900'
                }`}>
