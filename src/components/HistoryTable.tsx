      ...
      <div className={`p-6 border-b ${theme === 'dark'
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            <div className={`text-lg font-bold ${theme === 'dark' ? 'text-gray-300' : 'text-gray-300'
              }`}>
      ...
      <div className="p-6">
          ...
          <table className="w-full">
            ...
            <tbody>
              {displayedHistory.length === 0 ? (
                <tr>
                  <td colSpan={8} className={`py-8 text-center ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'
                    }`}>
                ...
                displayedHistory.map((record) => {
                  ...
                  return (
                    <tr
                      key={record.date}
                      className={`cursor-pointer transition-all ${isToday
                        ? theme === 'dark'
                          ? 'bg-blue-900/20'
                          : 'bg-blue-50'
                    ...
                    >
                      <td className={`py-3 px-4 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-800'
                        }`}>
                      ...
                      <td className="py-3 px-4">
                        {(() => {
                          ...
                          if (isWeekend) {
                            return (
                              <span className={`px-2 py-0.5 rounded-lg text-xs font-bold ${theme === 'dark' ? 'bg-indigo-900/40 text-indigo-400' : 'bg-indigo-100 text-indigo-700'
                                }`}>
                                BREAK
                              </span>
                            );
                          ...
                          return (
                            <div className="flex items-center">
                              <div className={`w-16 h-2 rounded-full overflow-hidden ${theme === 'dark' ? 'bg-gray-700' : 'bg-gray-300'
                                }`}>
                                <div
                                  className={`h-full ${outreachProgress >= 100 ? 'bg-emerald-500' :
                      ...
                      <td className="py-3 px-4">
                        <div className="flex items-center">
                          <div className={`w-16 h-2 rounded-full overflow-hidden ${theme === 'dark' ? 'bg-gray-700' : 'bg-gray-300'
                            ...
                            <div
                              className={`h-full ${projectProgress >= 100 ? 'bg-emerald-500' :
                      ...
                      <td className="py-3 px-4">
                        <div className="flex items-center">
                          <div className={`w-16 h-2 rounded-full overflow-hidden ${theme === 'dark' ? 'bg-gray-700' : 'bg-gray-300'
                            ...
                            <div
                              className={`h-full ${advanceProgress >= 100 ? 'bg-emerald-500' :
                      ...
                      {/* Learning Column */}
                      <td className="py-3 px-4">
                        <div className={`text-lg ${learningTask?.completed
                      ...
                      {/* Scrolling Column */}
                      <td className="py-3 px-4">
                        <div className={`text-lg ${scrollingTask?.completed
                          ? theme === 'dark' ? 'text-emerald-400' : 'text-emerald-600'
                          : theme === 'dark' ? 'text-rose-400' : 'text-rose-600'
                          }`}>
                      ...
                      {/* Trend Column */}
                      <td className="py-3 px-4">
                        <div className={`text-xl ${record.progress >= 80
                          ? theme === 'dark' ? 'text-emerald-400' : 'text-emerald-600'
        ...
        {uniqueHistory.length > 7 && (
          <div className="flex justify-center mt-6">
            <button
              ...
              className={`px-6 py-3 rounded-xl font-bold transition-all flex items-center gap-2 ${theme === 'dark'
        ...
        <div className={`mt-6 p-5 rounded-xl border-2 ${theme === 'dark'
          ...
          <div className="grid grid-cols-4 gap-6">
            <div>
              <div className={`text-base font-bold mb-2 ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'
                }`}>
                TOTAL DAYS
              </div>
